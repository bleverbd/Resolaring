  ...
  return (
    <div className="font-Syne bg-[#071431] text-[#C1C4CC]">
        ...
        <div className="max-w-[1520px] mx-auto">
            ...
            <div className="flex gap-15 pt-15 pb-10 ">
                ...
                <div className="flex flex-col gap-5 w-4/12">
                    ...
                    <div> 
                            ...
                            <div> <img src={footer_icon} alt="logo_Icon"></img> </div>
                            <div> <p className="text-white text-4xl font-semibold">Resolaring </p> </div>
                            </div>
                            <div> <p className="text-[#C1C4CC] text-[13px]">Recycling and installing panels for a better future</p> </div>
                    </div>

                    <div>
                        <p className="text-[#C1C4CC] text-[14px]">At Resolaring, we believe in creating a sustainable future by promoting the reuse and recycling of solar equipment. Our platform connects buyers and sellers of second-hand solar panels, reducing waste and supporting green energy initiatives.</p>
                    </div>

                    <div>
                        <div className="flex flex-col gap-2">
                            <div> <p className="text-white text-lg font-semibold"> Support</p></div>
                    ...
                    <div> <p className="text-white text-lg font-semibold"> Quick Link </p></div>
                    <div>
                    <FooterItem/>
                    </div>
                    </div>
                    ...
                    <div>
                        <p className="text-[#C1C4CC]">Our team is here to answer any questions you may have, so please contact us by filling out the following fields or directly via email or phone!</p>
                    </div>
                    ...
                    <div className=" flex flex-col gap-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <input className="mt-1 w-full border border-white/20 bg-white/10 rounded-sm text-[#C1C4CC] text-xs focus:outline outline-bg-btn-color py-3 px-5" type="text" placeholder="Name here"/>
                            </div>

                            <div >
                            <label className="text-white"> Cognoms*</label> <br/>
                            <input  className=" mt-1 w-full border border-white/20 bg-white/10 rounded-sm text-[#C1C4CC] text-xs focus:outline outline-bg-btn-color py-3 px-5" type="text" placeholder="Cognoms here"/> 
                            </div>

                            <div >
                            <label className="text-white"> Telephone*</label> <br/>
                            <input className="mt-1 w-full border border-white/20 bg-white/10 rounded-sm text-[#C1C4CC] text-xs focus:outline outline-bg-btn-color py-3 px-5" type="tel" placeholder="Number here"/>
                            </div>

                            <div >
                            <label className="text-white"> E-mail*</label> <br/>
                            <input  className=" mt-1 w-full border border-white/20 bg-white/10 rounded-sm text-[#C1C4CC] text-xs focus:outline outline-bg-btn-color py-3 px-5" type="email" placeholder="Email here"/>
                            </div>
            ...
            <div className="flex items-center justify-center gap-2 mt-5 pb-10 mx-auto"> <img className="w-[32px] h-[32px]" src={footer_icon}/> <p className="text-[#C1C4CC] text-sm"> Copyright 2025.  All Rights Reserved.  Powered by the Awesomeness of Fresh Fruit.</p></div>
